...
from student.models import Staff, Staff_Notification, Staff_leave, Staff_Feedback, \
    Subject, Session_Year, Student, Attendance, Attendance_Report, StudentResult
...
def STAFF_APPLY_LEAVE_SAVE(request):
    if request.method == "POST":
        ...
        leave.save()
        messages.success(request, 'Leave Application Was Successfully Sent !')
...
def STAFF_FEEDBACK_SAVE(request):
    if request.method == "POST":
        ...
        feedback.save()
        messages.success(request, 'Feed Back Are Successfully Send !')
...
def STAFF_TAKE_ATTENDANCE(request):
    ...
    messages.success(request, 'Attendance  Was Successfully Save !')
